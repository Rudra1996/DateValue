...
import com.find.date.model.Application;
import com.find.date.model.Dataprovider;

import com.find.date.model.Title;
...
public class RControl {
	...
	/*public List<DateVal> doGetJson(){
		
		return Arrays.asList(new DateVal("2001-10-10",10),new DateVal("2006-06-23",14));
		
	}*/
	public ResponseEntity<?> getJson(){
		Application ap=new Application();
		//Title t= new Title();
		/*DateVal d= new DateVal("2008-08-19",1);
		DateVal d1= new DateVal("2008-05-25",02);
		DateVal d2= new DateVal("2008-12-07",3);
		DateVal d3= new DateVal("2008-03-25",4);
		DateVal d4= new DateVal("2018-06-18",5);
		DateVal d5= new DateVal("2012-03-19",6);
		DateVal d6= new DateVal("2008-05-30",7);
		DateVal d7= new DateVal("2010-10-19",20);
		DateVal d8= new DateVal("2014-07-10",7);
		DateVal d9= new DateVal("2005-01-11",06);
		DateVal d10= new DateVal("2011-15-17",20);
		DateVal d11= new DateVal("2002-11-05",20);
		DateVal d12= new DateVal("2001-12-25",20);
		DateVal d13= new DateVal("2000-02-19",20);
		
		//ArrayList<DateVal> al= new ArrayList<>();
		//d.setDate("2008-05-26");
		//d.setVal(30);
		ap.setHanuman(new DateVal[] {d,d1,d2,d3,d4,d5,d6,d7,d8,d9,d10,d11,d12,d13});
		//(new DateVal[] {d,d1,d2,d3});
		//d.setTitle(t);
		//d.setDateVal(al);
		...
		*/
		...
		//dataprovider1.setDate("12-05-20");
		//dataprovider1.setValue(15);
		//dataprovider2.setDate("13-05-20");
		//dataprovider2.setValue(16);
		ap.setDataproviders(new Dataprovider[] {dataprovider,dataprovider1,dataprovider2,
